    ...
    <div style={{ background: '#fff', minHeight: '100vh', fontFamily: 'Inter, -apple-system, sans-serif', color: '#282C3F' }}>
      ...
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 48px', borderBottom: '1px solid #F0F0F0', position: 'sticky', top: 0, background: '#fff', zIndex: 100, height: 64 }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <button onClick={() => router.push('/login')} style={{ background: 'transparent', border: '1.5px solid #E9E9EB', color: '#282C3F', borderRadius: 8, padding: '8px 18px', fontWeight: 600, cursor: 'pointer', fontSize: 14, fontFamily: 'inherit' }}>
            Sign In
          </button>
          <button onClick={() => router.push('/login?mode=signup')} style={{ background: '#FC8019', border: 'none', color: '#fff', borderRadius: 8, padding: '8px 18px', fontWeight: 700, cursor: 'pointer', fontSize: 14, fontFamily: 'inherit' }}>
            Get Started Free
          </button>
        </div>
      </nav>
      ...
      <section style={{ background: 'linear-gradient(135deg, #FC8019 0%, #FF6B35 100%)', padding: '96px 48px', textAlign: 'center', color: '#fff' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={() => router.push('/login?mode=signup')} style={{ background: '#fff', color: '#FC8019', border: 'none', borderRadius: 10, padding: '15px 36px', fontWeight: 800, fontSize: 16, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 4px 20px rgba(0,0,0,.15)' }}>
              Start for Free →
            </button>
      ...
      <section id="pricing" style={{ padding: '72px 48px', background: '#FAFAFA' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ background: '#fff', borderRadius: 20, padding: '40px', border: '2px solid #FC8019', boxShadow: '0 8px 32px rgba(252,128,25,.12)' }}>
            ...
            <button onClick={() => router.push('/login?mode=signup')} style={{ marginTop: 24, width: '100%', padding: '14px', background: '#FC8019', color: '#fff', border: 'none', borderRadius: 10, fontWeight: 800, fontSize: 16, cursor: 'pointer', fontFamily: 'inherit' }}>
              Get Started Free →
            </button>
          </div>
        </div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #FC8019 0%, #FF6B35 100%)', padding: '80px 48px', textAlign: 'center', color: '#fff' }}>
        ...
        <button onClick={() => router.push('/login?mode=signup')} style={{ background: '#fff', color: '#FC8019', border: 'none', borderRadius: 10, padding: '16px 40px', fontWeight: 800, fontSize: 17, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 4px 20px rgba(0,0,0,.15)' }}>
          Create Free Account →
        </button>
      </section>
